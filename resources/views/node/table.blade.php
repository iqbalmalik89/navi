...
<div class="sbox">
	<div class="sbox-title"> 
		...
		<div class="sbox-tools" >
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Clear Search" onclick="reloadData('#{{ $pageModule }}','node/data?search=')"><i class="fa fa-trash-o"></i></a>
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Reload Data" onclick="reloadData('#{{ $pageModule }}','node/data?return={{ $return }}')"><i class="fa fa-refresh"></i></a>
			...
			<tr id="form-0" >
			  ...
			  @endif        
                ...
                <tr class="editable" id="form-{{ $row->id }}">
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->id }}" data-url="{{ url('node/show/'.$id) }}"><i class="fa fa-plus " ></i></a></td>								
					@endif			
				 ...
				 <td data-values="action" data-key="<?php echo $row->id ;?>">
					{!! AjaxHelpers::buttonAction('node',$access,$id ,$setting) !!}
