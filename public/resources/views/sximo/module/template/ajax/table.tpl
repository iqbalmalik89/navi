...
<div class="sbox">
	<div class="sbox-title"> 
		...
		<div class="sbox-tools" >
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Clear Search" onclick="reloadData('#{{ $pageModule }}','{class}/data?search=')"><i class="fa fa-trash-o"></i></a>
			...
			<tr id="form-0" >
			  ...
			  @endif        
                ...
                <tr class="editable" id="form-{{ $row->{key} }}">
					...
					<td ><input type="checkbox" class="ids" name="id[]" value="<?php echo $row->{key} ;?>" />  </td>					
